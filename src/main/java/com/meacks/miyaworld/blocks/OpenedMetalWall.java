...
import com.meacks.miyaworld.blockEntities.OpenedMetalWallEntity;
...
public class OpenedMetalWall extends Block {
    public static final String registryName = "opened_metal_wall";
    public OpenedMetalWall(){
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new OpenedMetalWallEntity();
    }
