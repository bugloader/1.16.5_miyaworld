...
public class GiantRobotModel<T extends GiantRobot> extends SegmentedModel<T> {
    ...
    public GiantRobotModel() {
        int i = 128;
        int j = 128;
        this.head = (new ModelRenderer(this)).setTexSize(128, 128);
        this.head.setPos(0.0F, -7.0F, -2.0F);
        this.head.texOffs(0, 0).addBox(-4.0F, -9.0F, -5.5F, 8.0F, 7.0F, 8.0F, 0.0F);
    ...
    public void prepareMobModel(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
        ...
        if (i > 0) {
            ...
            int j = p_212843_1_.getOfferFlowerTick();
            if (j > 0) {
